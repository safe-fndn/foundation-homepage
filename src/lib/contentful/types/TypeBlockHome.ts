...
export interface TypeBlogHomeFields {
  ...
  mostPopular: EntryFieldTypes.Array<
    EntryFieldTypes.EntryLink<TypePostSkeleton>
  >;
}

export type TypeBlogHomeSkeleton = EntrySkeletonType<
  TypeBlogHomeFields,
  "blogHome"
>;
export type TypeBlogHome<
  Modifiers extends ChainModifiers,
  Locales extends LocaleCode = LocaleCode
> = Entry<TypeBlogHomeSkeleton, Modifiers, Locales>;
