...
export const isEntryTypeButton = (
  obj: any
): obj is Entry<TypeButtonSkeleton, undefined, string> => {
  return getContentTypeSysId(obj) === "button";
};

export const isEntryTypeTag = (
  obj: any
): obj is Entry<TypeTagSkeleton, undefined, string> => {
  return getContentTypeSysId(obj) === "tag";
};

export const isEntryTypeAuthor = (
  obj: any
): obj is Entry<TypeAuthorSkeleton, undefined, string> => {
  return getContentTypeSysId(obj) === "author";
};

export const isEntryTypePost = (
  obj: any
): obj is Entry<TypePostSkeleton, undefined, string> => {
  return getContentTypeSysId(obj) === "post";
};

export const isEntryTypeExternalURL = (
  obj: any
): obj is Entry<TypeExternalUrlSkeleton, undefined, string> => {
  return getContentTypeSysId(obj) === "externalUrl";
};

export const isEntryTypeSimpleBaseBlock = (
  obj: any
): obj is Entry<TypeSimpleBaseBlockSkeleton, undefined, string> => {
  return getContentTypeSysId(obj) === "simpleBaseBlock";
};

export const isEntryTypeBaseBlock = (
  obj: any
): obj is Entry<TypeBaseBlockSkeleton, undefined, string> => {
  return getContentTypeSysId(obj) === "baseBlock";
};

export const isEntryTypeBlogHome = (
  obj: any
): obj is Entry<TypeBlogHomeSkeleton, undefined, string> => {
