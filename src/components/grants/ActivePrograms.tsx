...
export default function ActivePrograms() {
  return (
    <div className="px-[16px] max-w-[1242px] mx-auto">
      ...
      <div className="text-[#1a1a1a99] text-xl mt-4 mb-[60px]">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 border border-[#1a1a1a1a] rounded-[16px] p-8">
          ...
          <div className="text-[#1A1A1A] text-lg font-medium pb-3">Scope</div>
          <ul className="text-[#1a1a1a99] text-base leading-[180%] list-disc pl-5 pb-6">
            <li>
              Core Safe smart contracts (v1.1.1, v1.2.0, v1.3.0, v1.4.1,
              v1.5.0).
            </li>
            <li>
              Supported modules: Safe 4337 Module, Passkey Module, Social
              Recovery Module.
            </li>
            <li>
              Smart-contract-level vulnerabilities only (frontend/UI issues are
              out of scope).
            </li>
          </ul>
