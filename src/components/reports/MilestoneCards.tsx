    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
      {MILESTONES.map((m, i) => (
        <motion.div
          ...
          className="flex flex-col gap-3 p-5 bg-[#12ff800f] border border-[#12ff8030] rounded-2xl hover:bg-[#12ff801a] hover:border-[#12FF80] transition-all duration-200"
        >
          ...
          <p className="text-sm text-[#1A1A1A99] leading-relaxed">{m.body}</p>
        </motion.div>
      ))}
    </div>
  );
