...
export default function LetterSection() {
  return (
    <div className="max-w-[720px] flex flex-col gap-0">
      ...
      {/* Signature */}
      <div className="mt-12 pt-8 border-t border-[#12FF80] border-t-2 flex items-start gap-4">
        <span className="mt-1 inline-block w-1 h-10 bg-[#12FF80] rounded-full flex-shrink-0" />
        <div>
          <div className="text-2xl font-cursive text-[#1A1A1A]" style={{ fontFamily: 'Caveat, cursive', fontWeight: 400 }}>
            {LETTER_TO_BACKERS.signature}
          </div>
          <div className="text-xs text-[#1A1A1A99] mt-2 tracking-wide">
